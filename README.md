# node-calculator &middot; [![Build Status](https://travis-ci.com/ameerthehacker/node-calculator.svg?branch=master)](https://travis-ci.com/ameerthehacker/node-calculator)
